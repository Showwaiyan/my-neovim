		...
		vim.defer_fn(function()
			...
			for _, other_client in pairs(clients) do
				...
				if
					...
					and (
						not other_client.config.root_dir
						or (
							other_client.config.settings
							and other_client.config.settings.java
							and vim.tbl_isempty(other_client.config.settings.java)
						)
					)
				then
